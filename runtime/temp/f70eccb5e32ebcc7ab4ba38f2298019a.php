<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"E:\xampp\htdocs\tp5\public/../application/index\view\user\register.html";i:1482038767;}*/ ?>
 <!DOCTYPE html>
    ...
    function ajax() {
        ...
        $.post('doRegister', {
                ...
                if (data == 0) {
                    ...
                    window.location.href = '__SITE__/index/user/login';
                    return false;

                } else {

                        window.location.href = '__SITE__/index/user/login'; 
                     $(".code").next().html('<font color="red">验证码正确</font>');
                }
